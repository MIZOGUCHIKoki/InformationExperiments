...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
        ...
        \node[right=1cm of decision1](point1){};
        \node[right=1cm of decision2](point2){};
        % \draw(point1)--(point2);
        % \path[name intersections={of=point1 and point2}];
    \end{tikzpicture}
\end{figure}
\newpage
\subsection{処理}
\subsubsection*{\met{setFlag}}
今，入力として\ \verb|x|行\verb|y|列\ が与えられた．以下，\ \verb|x|行\verb|y|列\ を\((x,y)\)と記す．
\begin{enumerate}
